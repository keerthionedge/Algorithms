...
public class RunnerClass {
    ...
    public static void main(String[] args) {
        ...
        List<Integer> integers = randomArray();
        int[] a3 = toIntArray(integers);
        int size = (int) a3.length / 2;
        ...
        LOGGER.info("+interpolationSearch(a3," + a3[size] + ")" + interpolationSearch(a3, a3[size]));
        printAnArray();
    }
    ...
    public static List<Integer> randomArray() {
        ...
        for (int i = 0; i < 40500; ) {
            if (i < 4000)
                ...
                i = i + (int) (Math.random() * 47);
            else if (i < 40500)
                i = i + (int) (Math.random() * 13);
            list.add(i);
        }
        return list;
    }
